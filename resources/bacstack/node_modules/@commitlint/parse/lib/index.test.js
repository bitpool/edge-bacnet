...
(0, _ava2.default)('ignores comments', function (t) {
	return new Promise(function ($return, $error) {
		...
		message = 'type(some/scope): subject\n# some comment';
		return Promise.resolve((0, _importFrom2.default)(process.cwd(), 'conventional-changelog-angular')).then(function ($await_11) {
			try {
				changelogOpts = $await_11;
				opts = Object.assign({}, changelogOpts.parserOpts, { commentChar: '#' });
				return Promise.resolve((0, _2.default)(message, undefined, opts)).then(function ($await_12) {
					try {
						actual = $await_12;
		...
		return Promise.resolve((0, _importFrom2.default)(process.cwd(), 'conventional-changelog-angular')).then(function ($await_15) {
			try {
				...
				return Promise.resolve((0, _2.default)(message, undefined, opts)).then(function ($await_16) {
					try {
						_ref = $await_16, _ref$references = (0, _slicedToArray3.default)(_ref.references, 1), actual = _ref$references[0];
...
(0, _ava2.default)('parses custom references', function (t) {
	return new Promise(function ($return, $error) {
		...
		return Promise.resolve((0, _2.default)(message, undefined, {
			...
			try {
				_ref2 = $await_17, references = _ref2.references;
